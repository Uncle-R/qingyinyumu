<template>
	<div>
		...
		<mt-navbar v-model="selected">
			<mt-tab-item id="1">下载中</mt-tab-item>
			<mt-tab-item id="2">电台节目</mt-tab-item>
			<mt-tab-item id="3">MV</mt-tab-item>
			<mt-tab-item id="4">单曲</mt-tab-item>
		</mt-navbar>-->
		<mt-tab-container v-model="selected">
			...
			<mt-tab-container-item id="2">
				<div class="xiazai">
					<div class="xiazaiCon">
						<a class="m-sgitem" href="#" v-for="(list,index) in dianTaiList" key='index'>
							<div class="sgfl sgfl-cred">{{list.musicNum}}</div>
							<div class="sgfr f-bd f-bd-btm">
								<div class="sgchfl">
									<div class="f-thide sgtl">{{list.musicTitle}}</div>
